...
2.0 authentication across 10+ providers, and comprehensive audit logs alongside request analytics. It uses
TypeScript/Next.js for both the frontend and backend. More
technical details
